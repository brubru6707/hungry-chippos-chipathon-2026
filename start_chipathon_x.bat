...
:: - Added: support for gLayout installation by GLAYOUT_INSTALL,
::   GLAYOUT_REPOSITORY and GLAYOUT_FOLDER env variables
:: Modifications for X/WSLg local display:
:: - Removed VNC/webserver/Jupyter port mappings
:: - Added WSLg/X11 display passthrough (DISPLAY, WAYLAND_DISPLAY,
::   XDG_RUNTIME_DIR, PULSE_SERVER, and required volume mounts)
:: ========================================================================
...
IF "%CONTAINER_NAME%"=="" SET CONTAINER_NAME=iic-osic-tools_chipathon_x
