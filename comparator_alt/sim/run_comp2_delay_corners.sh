...
# netlisted from xschem, CKL=3.1n in the Vckl line):
#   TT (typical/ 27C/3.30V): od=0.5LSB and od=0.1mV        @ CKL=3.1n
#   SS (ss     /125C/2.97V): od=0.5LSB @ CKL=2.9/3.1/3.3n, od=0.1mV @ 3.1n
#   FF (ff     /-40C/3.63V): od=0.5LSB @ CKL=2.9/3.1/3.3n, od=0.1mV @ 3.1n
...
if ! grep -qi "^Vckl.*3\.1n" "$NETLIST"; then
  echo "WARNING: Vckl line in netlist does not contain 3.1n — was the schematic"
...
gen_deck tt_od0p5lsb_ckl3p1   typical   27   3.30  0.006457  3.1
gen_deck tt_od0p1mv_ckl3p1    typical   27   3.30  0.0001    3.1
gen_deck ss_od0p5lsb_ckl2p9   ss       125   2.97  0.006457  2.9
gen_deck ss_od0p5lsb_ckl3p1   ss       125   2.97  0.006457  3.1
gen_deck ss_od0p5lsb_ckl3p3   ss       125   2.97  0.006457  3.3
gen_deck ss_od0p1mv_ckl3p1    ss       125   2.97  0.0001    3.1
gen_deck ff_od0p5lsb_ckl2p9   ff       -40   3.63  0.006457  2.9
gen_deck ff_od0p5lsb_ckl3p1   ff       -40   3.63  0.006457  3.1
gen_deck ff_od0p5lsb_ckl3p3   ff       -40   3.63  0.006457  3.3
gen_deck ff_od0p1mv_ckl3p1    ff       -40   3.63  0.0001    3.1
...
echo "clean decision. FAILED lines at ckl3p1 = the design CKL does not"
echo "survive that corner; see which probe (2.9/3.3) works instead."
