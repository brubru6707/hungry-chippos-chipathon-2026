...
C {lab_pin.sym} 360 -150 2 0 {name=p5 sig_type=std_logic lab=VOUT2}
C {lab_pin.sym} 360 -170 2 0 {name=p6 sig_type=std_logic lab=VOUT1}
...
C {comparator_alt/schematic/comparator_alt.sym} 210 -160 0 0 {name=x1}
