...
N -70 -200 -70 20 {lab=#net1}
N -90 -200 -70 -200 {lab=#net1}
N -280 -200 -220 -200 {lab=#net2}
N -450 -200 -400 -200 {lab=#net3}
N -450 -200 -450 -0 {lab=#net3}
N 500 -200 500 40 {lab=#net4}
N 480 -200 500 -200 {lab=#net4}
N 300 -200 350 -200 {lab=#net5}
N 140 -200 180 -200 {lab=#net6}
N 140 -200 140 20 {lab=#net6}
...
N -220 100 -10 100 {lab=#net2}
N -10 20 -10 100 {lab=#net2}
N 500 40 510 40 {lab=#net4}
N 280 40 500 40 {lab=#net4}
N 110 20 160 20 {lab=#net6}
N 160 10 160 20 {lab=#net6}
N 160 10 210 10 {lab=#net6}
N 150 70 210 70 {lab=#net8}
N 150 70 150 240 {lab=#net8}
N -500 -0 -450 0 {lab=#net3}
N -450 0 -420 -0 {lab=#net3}
N -420 -10 -420 -0 {lab=#net3}
N -420 -10 -380 -10 {lab=#net3}
N -450 50 -380 50 {lab=#net8}
N -450 50 -450 240 {lab=#net8}
N -140 140 -140 350 {lab=VSS}
...
C {nor2.sym} -350 20 0 0 {name=x5}
C {nor2.sym} 240 40 0 0 {name=x6}
C {inv.sym} -200 210 3 1 {name=x11}
