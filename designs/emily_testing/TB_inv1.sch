...
F {}
E {}
B 5 117.5 -72.5 122.5 -67.5 {name=DVDD dir=inout}
B 5 87.5 -2.5 92.5 2.5 {name=vin dir=in}
B 5 217.5 -2.5 222.5 2.5 {name=vout dir=out}
B 5 117.5 57.5 122.5 62.5 {name=DVSS dir=inout}
...
"}
C {designs/emily_testing/inv1.sym} 190 0 0 0 {name=x1}
