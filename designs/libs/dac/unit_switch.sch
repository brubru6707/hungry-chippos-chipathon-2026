...
F {}
E {}
N -60 -130 -60 -70 {lab=CAP_PLATE}
N -60 -130 240 -130 {lab=CAP_PLATE}
N 240 -130 240 -70 {lab=CAP_PLATE}
N 70 -130 70 -70 {lab=CAP_PLATE}
N 240 -10 240 20 {lab=GND}
N 70 -10 70 20 {lab=VREF}
N -60 -10 -60 20 {lab=VIN}
N -130 -40 -100 -40 {lab=SAMPLE}
N -60 -40 -30 -40 {lab=GND}
N 70 -150 70 -130 {lab=CAP_PLATE}
...
C {iopin.sym} 70 -150 0 0 {name=p6 lab=VOUT}
